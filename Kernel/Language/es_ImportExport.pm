...
sub Data {
    ...
    $Self->{Translation}->{'Do you really want to delete this template item?'} = '¿Realmente desea eliminar este elemento de plantilla?';
    ...
    $Self->{Translation}->{'Template was deleted successfully.'} = 'La plantilla se eliminó correctamente.';
