...
sub Data {
    ...
    $Self->{Translation}->{'Format backend module registration for the import/export module.'} =
        'Форматирайте регистрацията за backend модул на модула за импортиране/експортиране.';
    $Self->{Translation}->{'Import and export object information.'} = 'Импортиране и експортиране на информация за обекта.';
    $Self->{Translation}->{'Import/Export'} = 'Импорт/Експорт';
